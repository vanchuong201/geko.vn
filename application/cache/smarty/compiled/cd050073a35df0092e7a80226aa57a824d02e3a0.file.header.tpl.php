<?php /* Smarty version Smarty-3.1.17, created on 2015-01-26 09:30:57
         compiled from "application\views\Header\header.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3261654c5fb41c16e81-16838774%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cd050073a35df0092e7a80226aa57a824d02e3a0' => 
    array (
      0 => 'application\\views\\Header\\header.tpl',
      1 => 1422260913,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3261654c5fb41c16e81-16838774',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_54c5fb41c94e96_85897523',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_54c5fb41c94e96_85897523')) {function content_54c5fb41c94e96_85897523($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
assets/plugins/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    <link href="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/plugins/bootstrap/css/bootstrap.css" rel="stylesheet" type="text/css">
    <!-- Global styles END -->
...
assets/plugins/layerslider/css/layerslider.css" type="text/css">
    ...
    <div role="navigation" class="navbar header no-margin">
        <div class="container">
            <div class="navbar-header">
                ...
                <a href="index.html" class="navbar-brand"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/img/logo_red.png" alt="Metronic Shop UI"></a><!-- LOGO -->
            </div>
            <!-- BEGIN CART -->
                ...
                <div class="cart-content-wrapper">
                    <div class="cart-content">
                        <ul class="scroller" style="height: 250px;">
                            <li>
                                <a href="item.html"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/cart-img.jpg" alt="Rolex Classic Watch" width="37" height="34"></a>
                            ...
                            <li>
                                <div class="nav-content">
                                    ...
                                    <div class="nav-brands">
                                        <ul>
                                            <li><a href="product-list.html"><img title="esprit" alt="esprit" src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/brands/esprit.jpg"></a></li>
                                            <li><a href="product-list.html"><img title="gap" alt="gap" src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/brands/gap.jpg"></a></li>
                                            <li><a href="product-list.html"><img title="next" alt="next" src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/brands/next.jpg"></a></li>
                                            <li><a href="product-list.html"><img title="puma" alt="puma" src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/brands/puma.jpg"></a></li>
                                            <li><a href="product-list.html"><img title="zara" alt="zara" src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/brands/zara.jpg"></a></li>
                                        </ul>
                                    </div>
                                ...
                                <div class="nav-content">
                                    <div class="product-item">
                                        <div class="pi-img-wrapper">
                                            <a href="item.html"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/products/model4.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                                        </div>
                                    ...
                                    <div class="product-item">
                                        <div class="pi-img-wrapper">
                                            <a href="item.html"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/products/model3.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                                        </div>
                                        <h3><a href="item.html">Berry Lace Dress</a></h3>
                                        <div class="pi-price">$29.00</div>
                                        <a href="#" class="btn btn-default add2cart">Add to cart</a>
                                    ...
                                    <div class="product-item">
                                        <div class="pi-img-wrapper">
                                            <a href="item.html"><img src="<?php echo $_smarty_tpl->tpl_vars['base_url']->value;?>
assets/temp/products/model7.jpg" class="img-responsive" alt="Berry Lace Dress"></a>
                                        </div>
                                        <h3><a href="item.html">Berry Lace Dress</a></h3>
                                        <div class="pi-price">$29.00</div>
                                        <a href="#" class="btn btn-default add2cart">Add to cart</a>
