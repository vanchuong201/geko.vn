...
<script src="{url}assets/plugins/bootstrap2/js/bootstrap.min.js" type="text/javascript"></script>
...
<script src="{url}assets/scripts/core/app.js" type="text/javascript"></script>
